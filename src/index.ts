...
const MODULES = [
  ...
  // Frontend Modules
  { name: 'ui-components', category: 'frontend', description: 'Tailwind CSS React UI components', techStack: ['React', 'TypeScript', 'Tailwind CSS'], version: 'v0.1.0', cicd: true },
  { name: 'api-client', category: 'frontend', description: 'Axios REST API client', techStack: ['TypeScript', 'Axios'], version: 'v0.1.0', cicd: true },
  { name: 'state-management', category: 'frontend', description: 'Redux Toolkit state management', techStack: ['TypeScript', 'Redux Toolkit'], version: 'v0.1.0', cicd: true },
  { name: 'form-validation', category: 'frontend', description: 'React Hook Form + Zod validation', techStack: ['React', 'TypeScript', 'Zod'], version: 'v0.1.0', cicd: false },
  { name: 'routing', category: 'frontend', description: 'React Router navigation', techStack: ['React', 'TypeScript', 'React Router'], version: 'v0.1.0', cicd: true },
  { name: 'auth-client', category: 'frontend', description: 'Frontend authentication client', techStack: ['TypeScript', 'React'], version: 'v0.1.0', cicd: true },
  { name: 'error-handling', category: 'frontend', description: 'Error Boundary components', techStack: ['React', 'TypeScript'], version: 'v0.1.0', cicd: false },
  { name: 'websocket-client', category: 'frontend', description: 'WebSocket client for real-time communication', techStack: ['TypeScript', 'WebSocket'], version: 'v0.1.0', cicd: false },
  { name: 'i18n', category: 'frontend', description: 'Internationalization with i18next', techStack: ['React', 'TypeScript', 'i18next'], version: 'v0.1.0', cicd: false },
  { name: 'chart-components', category: 'frontend', description: 'Chart.js React chart components', techStack: ['React', 'TypeScript', 'Chart.js'], version: 'v0.1.0', cicd: false },
  { name: 'table-components', category: 'frontend', description: 'TanStack Table components', techStack: ['React', 'TypeScript', 'TanStack Table'], version: 'v0.1.0', cicd: false },
  { name: 'analytics-client', category: 'frontend', description: 'Google Analytics integration', techStack: ['TypeScript', 'Google Analytics'], version: 'v0.1.0', cicd: false },
